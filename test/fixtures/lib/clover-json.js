 ...
 * @param {String} [opts.dir] the directory in which to the clover.json will be written
 * @param {String} [opts.file] the file name, defaulted to config attribute or 'clover.json'
 * @example
 * Usage
 * -----
 * var report = require('istanbul').Report.create('clover-json');
 */
function CloverJSONReport(opts) {
    ...
    this.file = opts.file || 'clover.json';
    this.opts = opts;
}

CloverJSONReport.TYPE = 'clover-json';
