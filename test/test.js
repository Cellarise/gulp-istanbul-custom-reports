...
describe('gulp-istanbul', function () {
    ...
    describe('istanbul.registerReport()', function () {

        it('register custom report', function (done) {
            istanbul.registerReport(require('./fixtures/lib/clover-json'));
            var invalid = _.difference(['clover-json'], istanbul.istanbul().Report.getReportList());
            assert.ok(invalid);
            done();
        });
